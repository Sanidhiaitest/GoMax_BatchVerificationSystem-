...
// Icon-only badge (no wordmark text) for dark hero headers and compact
// corners where the full lockup would compete with existing content.
export function GoMaxBadge({ size = 38 }: { size?: number }) {
  return (
    <span className="gomax-badge" style={{ width: size, height: size }}>
      <svg width={size * 0.47} height={size * 0.47} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
